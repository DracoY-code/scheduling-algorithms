...
class Scheduler:
    """The class to implement the LJF scheduler.
    """
    def __init__(self) -> None:
        print('<<< Longest Job First Scheduler >>>\n')
...
if __name__ == '__main__':
    ...
    p1: Process = Process('P1', 1, 2)
    p2: Process = Process('P2', 2, 4)
    p3: Process = Process('P3', 3, 6)
    p4: Process = Process('P4', 4, 8)
